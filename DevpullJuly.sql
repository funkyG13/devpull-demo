CREATE DATABASE  IF NOT EXISTS `devpull` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `devpull`;
...
CREATE TABLE `languages` (
  ...
  `language_name` varchar(45) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `languages` VALUES (1,'JAVA'),(2,'C#'),(3,'Python'),(4,'Javascript'),(5,'Ruby');
...
INSERT INTO `user` VALUES (1,1,'Mike','Mike','mike','mike','mike@gmail.com'),(2,2,'Alex','Alex','alex','alex','alex@gmail.com'),(3,3,'Intrasoft','Co.','intra','intra','intrasoft@gmail.com'),(4,3,'Vodafone','Co.','voda','voda','vodafone@vodafonenet.com'),(5,2,'Takis','Tatakis','takis','takis','tatakis@gmail.com');
...
INSERT INTO `user_lang` VALUES (1,2),(1,3);
...
-- Dump completed on 2019-07-05 12:27:48
